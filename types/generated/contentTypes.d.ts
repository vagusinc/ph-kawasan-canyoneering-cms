...
export interface ApiAddonAddon extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    pricePerPerson: Attribute.Decimal;
...
export interface ApiPickupAndDropoffPackagePickupAndDropoffPackage
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    minimumPersons: Attribute.Integer;
    maximumPersons: Attribute.Integer;
    price: Attribute.Decimal;
    tour: Attribute.Relation<
      'api::pickup-and-dropoff-package.pickup-and-dropoff-package',
      'manyToOne',
      'api::tour.tour'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiTourTour extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasPickup: Attribute.Boolean;
    hasDropoff: Attribute.Boolean;
    pricePerPerson: Attribute.Decimal;
    pickup_and_dropoff_packages: Attribute.Relation<
      'api::tour.tour',
      'oneToMany',
      'api::pickup-and-dropoff-package.pickup-and-dropoff-package'
    >;
    ...
    tour_options: Attribute.Relation<
      'api::tour.tour',
      'oneToMany',
...
export interface ApiTourOptionTourOption extends Schema.CollectionType {
...
export interface ApiTourVideoTourVideo extends Schema.CollectionType {
  collectionName: 'tour_videos';
  info: {
    singularName: 'tour-video';
    pluralName: 'tour-videos';
    displayName: 'TourVideo';
    description: '';
  };
  options: {
    draftAndPublish: true;
